    ...
    if(xi == 1) {
      ...
      if(l_kuce[x] == l_kuce[x+1]) {
        if(sirina_broj>69) {
          ...
          out +=
          "<tr><td id='kc" + g_5_kuca[jjj] + "' onmouseover='prikazi_scene(" + g_5_kuca[jjj] + ")' onmouseout='sakrij_scene(" + g_5_kuca[jjj] + ")' class=xindigo><input type='button' onmouseover='prikazi_scene(" + g_5_kuca[jjj] + ")' onclick='na_sceni(" + c + "," + mm + ",1)' value='" + strsc1 + "'></td></tr>";
        }
        ...
        while(l_kuce[y] == l_kuca) {
          ...
          ekstenzija += "<tr><td style='position:inherit' id='sc" + g_5_id[jjjj] + "' class=xindigo7><input type='button' onclick='na_sceni(" + cc + "," + mm + ",2)' value='" + strsc22 + "'></td></tr>";
          y++;
        }
