...
function pisanje_kalendara(m,g,sw) { // sw odredjuje mesto upisivanja kalendara, prosledjuje se
	...
	rr=0;
	klndr = "<div " + uklon + " class=iks>&nbsp;X&nbsp;</div>";
	klndr+="<table>";
...
function radno_vreme() {
	...
	var z = d.getMonth();
	var xx = d.getDate();
	if(z==1 && xx==1) return 0;
	if(z==1 && xx==2) return 0;
	if(z==12 && xx==31) return 0;
...
function naslovna() {
  ...
  if(sirina_broj < 769) {
	...
	var out = "<table class=xcrno style='width:80%; overflow-x: auto;'><tr><td class=xindigo2 colspan='3' style='overflow-x: auto;'>";
	...
	out += "<input type='button' value='zabava' class=xindigo2 id='dugme_zabava' onclick='edt_zabava()'></td></tr></table></td></tr></table>";
	if(document.getElementById("hid_02").value == "vikend") {
		 out = "<table class=xcrno style='width:100%;'><tr><td class=xindigo2 colspan='3'>specijalna vikend ponuda</td></tr></table>";
	}
	if(document.getElementById("hid_vr").value == "opera") {
		 out = "<table class=xcrno style='width:100%;'><tr><td class=xindigo2 colspan='3'>*** opera *** opera *** opera ***</td></tr></table>";
	}
	var duzina = 0;
...
function edt_zabava() {
  ...
  if(sirina_broj < 769) {
	...
	out += "<input type='button' value='zabava' class=xindigo3 id='dugme_zabava' onclick='edt_zabava()'></td></tr></table></td></tr></table>";
	var duzina = 0;
...
function red_spec_cena(iz_r,ktgg) {
	...
	var out = "<tr><td><div class='dugme' onclick='na_dan(" + g_2_dd[aa[0]] + "," + g_2_mm[aa[0]] + "," + g_2_yy[aa[0]] + ")'>";
