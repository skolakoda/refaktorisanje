...
function prikazikarte(paket,podig,rezerv,neistek,minusjedan) {
  ...
  var slikovito = "";//radovi
  var ostatak = brojmesta - podignuto;
  var out = "<div>ukupno " + brojmesta + "</div>";
  out += "<div>podignuto " + podignuto + "</div>";
  out += "<div>rezervisano " + rezervisano + "</div>";
  out += "<div>ostalo " + ostatak + "</div>";
  out += "<div>još važe " + neistek + "</div>";
  out += "<div style='color:red; font-weight: bold;'>slobodno " + (ostatak *1 - neistek *1) + "</div>";
  out += "<div>štampano (Daca carica): " + minusjedan + "</div>";
  out += "<div>obri&#353;i <input type='text' size='2' id='zabrisanje' value='0'> nenum karata <input type='text' size='3' id='vrste' value='7'> vrste <input type='button' onclick='brisanje_nenum()'></div>";
