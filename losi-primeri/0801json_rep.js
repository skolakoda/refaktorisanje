function ceo_predst_info(di,dx) {
  ...
  url = g_prefiks + "pozorista.net/np/get_predst_info.php?akcija=-103";
...
function scene_listic(xi) {
  ...
  for(x=0;x<red_scena.length;x++) {
    ...
    if(xi == 1) {
      ...
      if(l_kuce[x] == l_kuce[x+1]) {
        if(sirina_broj>69) {
          out +=
          "<tr><td id='kc" + g_5_kuca[jjj] + "' onmouseover='prikazi_scene(" + g_5_kuca[jjj] + ")' class=xindigo><input type='button' onmouseover='prikazi_scene(" + g_5_kuca[jjj] + ")' onclick='na_sceni(" + c + "," + mm + "," + godinak + ",1)' value='" + strsc1 + "'></td></tr>";
        } else {
          out +=
          "<tr><td id='kc" + g_5_kuca[jjj] + "' onmouseover='prikazi_scene(" + g_5_kuca[jjj] + ")' onmouseout='sakrij_scene(" + g_5_kuca[jjj] + ")' class=xindigo><input type='button' onmouseover='prikazi_scene(" + g_5_kuca[jjj] + ")' onclick='na_sceni(" + c + "," + mm + "," + godinak + ",1)' value='" + strsc1 + "'></td></tr>";
        }
        ...
        while(l_kuce[y] == l_kuca) {
          ...
          ekstenzija += "<tr><td style='position:inherit' id='sc" + g_5_id[jjjj] + "' class=xindigo7><input type='button' onclick='na_sceni(" + cc + "," + mm + "," + godinak + ",2)' value='" + strsc22 + "'></td></tr>";
          y++;
        }
        ...
        out +=
        "<tr><td id='kc" + g_5_kuca[jjj] + "' class=xindigo><input type='button' onclick='na_sceni(" + c + "," + mm + "," + godinak + ",1)' value='" + strsc1 + "'></td></tr>";
      }
    }
    if(xi == 2) {
      if(kcs == kcn) {
  ...
  if(xi==1) {
  g_scen_id = c;
    //out = "klub ponovo radi po&#269;ev od petka, 1. septembra";
  ...
  if(xi==3) {
    //alert(out);
    document.getElementById("pid173").innerHTML=out;
  }
  ...
  } else if (document.getElementById("hid_ak").value != ".") {
    prikaz_aktera(document.getElementById("hid_ak").value,1);
  } else {
...
function scene_list() {
  ...
  url = g_prefiks + "pozorista.net/np/get_rep.php?akcija=2021";
