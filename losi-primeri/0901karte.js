...
function prikazi_sc_dg(dg,ktg) {
	url = g_prefiks + "pozorista.net/np/p_e.php?akcija=cl_po_pr&sta=" + dg + "&ktg=" + ktg;
	copyToClipboard(url);
...
function analiza_xmlhttp_sc_dg(response) {
  ...
  out = out.substr(0,out.length - 8) + "</table><table><tr><td>ukupno podignuto: " + zbir + " * još važećih: " + zbirrr + " * placeno-nepodignuto: <b style='font-size:large; color:#7f0000;'>" + zbirx + "</b> * stampano: " + arr[0].stmp + " * slobodno: " + razlika + "</td></tr></table>";
  alert("ukupno gresaka: " + out);
